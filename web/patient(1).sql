...
--
-- Host: localhost
-- Generation Time: Aug 20, 2018 at 07:13 PM
...
CREATE TABLE `patient` (
  ...
  `meeting date` varchar(60) NOT NULL,
  `meeting time` varchar(60) NOT NULL
...
INSERT INTO `patient` (`id`, `name`, `email`, `phone`, `gender`, `catagory`, `date`, `comment`, `meeting date`, `meeting time`) VALUES
